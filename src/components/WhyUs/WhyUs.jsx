...
const WhyUs = () => {
  return (
    <div className={style.containerWhyUs}>
      <Row>
        <Col>
          <div className={style.title}>Why Us?</div>
      ...
      <Row className={style.listItem}>
        <Col sm={12} lg={3}>
          <Card className="my-2">
            <Card.Body>
              ...
              <Card.Subtitle className="fw-bold my-3">
                Mobil Lengkap
              </Card.Subtitle>
              <Card.Text className="fw-medium">
                Tersedia banyak pilihan mobil, <br /> kondisi masih baru, bersih
                dan terawat
              </Card.Text>
            </Card.Body>
          </Card>
        ...
        <Col sm={12} lg={3}>
          <Card className="my-2">
            <Card.Body>
              <Card.Title className={style.titleList}>
                <img src={icon24hrs} />
              </Card.Title>
              <Card.Subtitle className="fw-bold my-3">
                Layanan 24 Jam
